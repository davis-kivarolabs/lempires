...
const Contact = () => {
  return (
    <>
          ...
          <div className='contact_details_inputs_wrapper' >
            ...
            <div className='contact_details text-[#9B9B9C] text-[14px]' style={{ display: "flex", flexDirection: "column", gap: "23px" }} >
              <div className='flex gap-[10px]' >
                ...
                <div className='flex gap-[10px]' >
                  <a href="tel:+917012191993" >+91-7012191993</a>
                  <a href="tel:+919633888123">+91-9633888123</a>
                </div>
              </div>
              <div className='flex gap-[10px]' >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='flex' >
                  <a href="mailto:info@lempirebuilders.com">info@lempirebuilders.com</a>
                </div>
              </div>
      ...
      <Footer title='Kickstart your project' />
    </>
  )
}
